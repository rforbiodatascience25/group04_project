...
raw_data1 <- ggplot(borovecki_data, aes(x = expressionValue)) +   
...
raw_histogram <- ggplot(borovecki_data, aes(x = expressionValue)) +
...
log2_histogram <- ggplot(borovecki_data, aes(x = log2_expression)) +
...
```{r}
Comparison_of_HTT_vs_MHL1_Expression <- ggplot(genes_info, aes(x = HTT, y = MLH1)) +
  geom_point(alpha = 0.6) +
  geom_smooth() +
  labs(
...
```{r}
Comparison_of_HTT_vs_PMS1_Expression <- ggplot(genes_info2, aes(x = HTT, y = PMS1)) +
  geom_point(alpha = 0.6) +
  geom_smooth() +
  labs(
